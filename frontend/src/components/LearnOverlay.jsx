...
const TIPS = {
  ...
  'vault': 'TOKEN VAULT = Auth0 securely stores your Gmail & Calendar login tokens. The app NEVER sees your password \u2014 it only gets permission to send alerts.',
  ...
  'token-lifecycle': 'TOKEN LIFECYCLE = The journey of your OAuth token: 1) You authorize access 2) Auth0 receives the token 3) Token Vault stores it encrypted 4) When it expires, Auth0 auto-refreshes it 5) Our agent uses the fresh token to call Gmail/Calendar API. You never have to re-login.',
